/* -------------------------------------------------------------------------
   VARIABLES GLOBALES
---------------------------------------------------------------------------*/
var psgdump = null;      // Contiendra les données décompressées (14 octets * frameCount)
var frameCount = 0;
...
function fillBuffer(e) {
    ...
    for (var i = 0; i < left.length; i++) {
        ...
        if (isrCounter >= 1) {
            ...
            // Lecture des 14 registres de la frame courante (décompressée)
